...
# print(
#     f'fullname: {Person_Info.fulname} \n age: {Person_Info.age} \n married: {Person_Info.married}\n')
...
#         super().__init__(fullname, age, is_married)
#         self.expiriance = experiance
#         self.salary = salary
# # ? nado sdelat rashet salary v classe teacher


# Teacher_info = Teacher('ADIL ADiL', 32, 'yes', 'one years', '1400$')
# print(f'{Teacher_info.fulname} {Teacher_info.age} {Teacher_info.married} {Teacher_info.expiriance} {Teacher_info.salary}')
# * 7-8 pynkt
class Teacher(Person):
